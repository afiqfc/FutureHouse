...
<head>
  ...
  <title>Beranda - FutureHouse Admin</title>
        ...
        <div class="col-lg-8">
          <div class="row">
                        ...
                        <div class="col-12">
                          <div class="card info-card customers-card Shadow-sm w-100">
                            <div class="card-body text-center py-4">
                              <h4 class="mb-2">Selmat datang di Website Admin
                                <strong>FutureHouse</strong></h4>
            ...
            <div class="col-xxl-4 col-md-6">
              ...
              $result = mysqli_query($koneksi, $query);
              $data = mysqli_fetch_assoc($result);
              $totalReveune = $data['total_revenue'] ?? 0;
              ?>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>Rp<?php echo number_format($totalReveune, 0, ',' , '.'); ?></h6>
