...
<head>
    ...
    <title>Transaksi - FutureHouse Admin</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <main id="main" class="main">
        ...
        // Ambil kategori dari data base untuk dropdown filter
        ...
        $sql .= " GROUP BY j.id_jual ORDER BY j.tgl_jual ASC"; // mengelompokan dan mengurutkan berdasarkan  tanggal terbaru
                ...
                <div class="card">
                    <div class="card-body">
                       <div class="filter-bar mt-3">
                        <form class="filter-form d-flex align-item-center" method="GET" action="">
                            <select name="kategori" class="form-select me-2" style="max-width: 200px;" tittle="Pilih kateri">
